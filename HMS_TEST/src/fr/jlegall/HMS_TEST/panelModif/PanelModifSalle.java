...
public class PanelModifSalle extends JPanel implements ActionListener, MouseListener {
    ...
    public PanelModifSalle(FenetrePrincipale fen) {
        this.fen = fen;
    ...
    private void construirePanel() {
        ...
        JLabel titre = new JLabel("Modifer salle  :        ");
        titre.setFont(new Font("Source Code Pro Black", Font.BOLD, 24));
        titre.setForeground(Color.black);

        ComboBoxSalleModif choixSalle = new ComboBoxSalleModif(this);
        ...
        JLabel idlabel = new JLabel("ID salle : ");
        idlabel.setFont(new Font("Source Code Pro Black", Font.BOLD, 14));
        idlabel.setForeground(Color.black);
        JLabel nomlabel = new JLabel("Nom salle : ");
        ...
        ButtonSalleModif btnValid = new ButtonSalleModif("MODIFIER", this);
    ...
    public boolean setTextField(String str) {
        ...
        for (Salle s : this.listeSalle) {
            if (s.getNomSalle().equals(str)) {
                ...
                this.idT = Integer.toString(s.getIdSalle());
                this.nomT = s.getNomSalle();
