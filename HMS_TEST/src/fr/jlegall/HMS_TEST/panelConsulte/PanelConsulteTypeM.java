...
public class PanelConsulteTypeM extends JPanel{
   
   private List<TypeM> listeType;

   public PanelConsulteTypeM() {
      TypeMDAO type = new TypeMDAO();
      this.listeType = type.findAll();
      construirePanel();
   }
   ...
   private void construirePanel() {
      ...
      JLabel num = new JLabel("Numéro du type");
      ...
      JLabel nom = new JLabel("Nom du type");
      ...
      for (TypeM t : this.listeType) {
         ...
         JLabel idSalle = new JLabel(Integer.toString(t.getIdTypeM()));
         JLabel nomSalle = new JLabel(t.getNomTypeM());
      ...
      panCenter.setPreferredSize(new Dimension(547, 30 * this.listeType.size()));
