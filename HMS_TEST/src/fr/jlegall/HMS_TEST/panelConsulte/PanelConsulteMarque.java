...
public class PanelConsulteMarque extends JPanel {

    private List<Marque> listeMarque;

    public PanelConsulteMarque() {
    ...
    private void construirePanel() {
        ...
        JLabel num = new JLabel("Numéro de la marque");
        ...
        JLabel nom = new JLabel("Nom de la marque");
        ...
        for (Marque m : this.listeMarque) {
            ...
            JLabel idMarque = new JLabel(Integer.toString(m.getIdMarque()));
            JLabel nomMarque = new JLabel(m.getNomMarque());

            idMarque.setHorizontalAlignment((int) CENTER_ALIGNMENT);
            nomMarque.setHorizontalAlignment((int) CENTER_ALIGNMENT);

            panId.add(idMarque);
            panNom.add(nomMarque);
        ...
        panCenter.setPreferredSize(new Dimension(547, 30 * this.listeMarque.size()));
