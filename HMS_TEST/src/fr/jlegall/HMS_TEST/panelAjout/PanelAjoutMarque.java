...
public class PanelAjoutMarque extends JPanel implements ActionListener, MouseListener, KeyListener{

    private JLabel ajoutMarque;
    ...
    public PanelAjoutMarque(FenetrePrincipale fenetre) {
        
        this.fenetre = fenetre;

        this.ajoutMarque = new JLabel();        
        this.ajoutMarque.setText("Nom de la marque :");
        this.ajoutMarque.setFont(new Font("Source Code Pro Black", Font.BOLD, 20));
        this.ajoutMarque.setForeground(Color.black);
    ...
    public void actionPerformed(ActionEvent e) {
        if (!this.field.getText().equals("") && !this.field.getText().equals("(CHAMPS VIDE)")) {
            ...
            String newMarque = field.getText();
            Marque marque = new Marque(0, newMarque);
