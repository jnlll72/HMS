...
public class PanelAjoutComposant extends JPanel implements ActionListener, MouseListener, KeyListener{

    private JLabel ajoutComposant;
    ...
    public PanelAjoutComposant(FenetrePrincipale fenetre) {
        
        this.fenetre = fenetre;

        this.ajoutComposant = new JLabel();        
        this.ajoutComposant.setText("Nom du composant :");
        this.ajoutComposant.setFont(new Font("Source Code Pro Black", Font.BOLD, 20));
        this.ajoutComposant.setForeground(Color.black);
        ...
        this.panelC.add(ajoutComposant);
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ENTER && !this.field.getText().equals("")) {
            ...
            String newComposant = field.getText();
            Composant salle = new Composant(0, newComposant);
            composantDao.create(salle);
